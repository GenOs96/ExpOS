...
void drip() {
	kprint_at_blue("E",  32, 0);
	kprint_at_blue("x",  32, 1);
	kprint_at_blue("p",  31, 2);
	kprint_at_blue("O",  31, 3);
	kprint_at_blue("S",  29, 4);
	kprint_at_blue("-",  27, 5);
	kprint_at_blue("v",  25, 6);
	kprint_at_blue("-",  24, 7);
	kprint_at_blue("0",  23, 8);
	kprint_at_blue(".",  23, 9);
	kprint_at_blue("0",  24, 10);
	kprint_at_blue("0",  25, 11);
	kprint_at_blue("1",  27, 12);
